...
@section('subtitle', 'Manage driving license and citizenship quiz questions')
            ...
            <tbody class="divide-y divide-gray-100">
                @forelse($questions as $q)
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-3">
                            <p class="font-medium text-gray-800 max-w-sm truncate">{{ $q->question }}</p>
                        </td>
                        <td class="px-6 py-3">
                        ...
                        <td class="px-6 py-3 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <a href="{{ route('admin.quiz.edit', $q) }}"
