    ...
    <form method="POST" action="{{ route('admin.offices.update', $office) }}" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="name_np" value="{{ old('name_np', $office->name_np) }}"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <select name="category" required
                    ...
                    @foreach(['passport', 'transport', 'tax', 'municipality', 'police', 'ward', 'dao'] as $cat)
                        <option value="{{ $cat }}" {{ old('category', $office->category) === $cat ? 'selected' : '' }}>{{ ucfirst($cat) }}</option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <input type="text" name="address" value="{{ old('address', $office->address) }}" required
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="district" value="{{ old('district', $office->district) }}" required
            ...
            <div>
                ...
                <input type="text" name="province" value="{{ old('province', $office->province) }}" required
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
                ...
                <input type="url" name="website" value="{{ old('website', $office->website) }}"
                       class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
        </div>
        ...
        <div>
            ...
            <input type="text" name="office_hours" value="{{ old('office_hours', $office->office_hours) }}"
                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
        </div>
