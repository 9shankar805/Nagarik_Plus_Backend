...
class AuthProvider extends ChangeNotifier {
  ...
  Future<void> register({
    ...
    try {
      ...
      _status = AuthStatus.initial; // OTP sent successfully
    } catch (e) {
  ...
  Future<void> verifyRegistrationOtp({
    ...
    notifyListeners();
    try {
      final response = await _repository.verifyRegistrationOtp(
  ...
  Future<void> verifyResetPasswordOtp({
    ...
    notifyListeners();
    try {
      await _repository.verifyResetPasswordOtp(email: email, otp: otp);
    } catch (e) {
      rethrow;
    } finally {
      _isLoading = false;
