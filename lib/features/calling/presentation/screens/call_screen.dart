              ...
              Row(
                ...
                children: [
                  _buildControlButton(
                    ...
                    backgroundColor: _isMuted ? Colors.grey : Colors.white.withValues(alpha: 0.3),
                    onPressed: _toggleMute,
                  ),
                  if (widget.isVideoCall)
                    _buildControlButton(
                      icon: _isVideoOff ? Icons.videocam_off : Icons.videocam,
                      backgroundColor: _isVideoOff ? Colors.grey : Colors.white.withValues(alpha: 0.3),
                  ...
                  _buildControlButton(
                    ...
                    backgroundColor: _isSpeakerOn ? Colors.white.withValues(alpha: 0.3) : Colors.grey,
