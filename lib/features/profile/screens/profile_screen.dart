...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _openStaticScreen(String title, String key) async {
    final provider = context.read<ProfileProvider>();
    final content = await provider.fetchStaticContent();
    if (mounted) {
      Navigator.push(
        context,
        MaterialPageRoute(
  ...
  Future<void> _rateApp() async {
    final provider = context.read<ProfileProvider>();
    final content = await provider.fetchStaticContent();
    final urlString = content['rate_app_url'] as String?;
  ...
  Widget build(BuildContext context) {
    ...
    final notificationsOn = notifProvider.preferences.news &&
        notifProvider.preferences.reminders;
          ...
          SliverToBoxAdapter(child: _buildSection(
            ...
            [
              ...
              _SettingItem(
                ...
                trailing: _toggle(notificationsOn, (v) {
                  final prefs = notifProvider.preferences;
                  notifProvider.updatePreferences(prefs.copyWith(
                    news: v,
                    documents: v,
                    reminders: v,
                    services: v,
          ...
          SliverToBoxAdapter(child: _buildSection(
            context.l10n.supportSection,
              _SettingItem(
                ...
                onTap: () => _openStaticScreen('Help & FAQ', 'help_faq'),
              ),
              _SettingItem(
              ...
              _SettingItem(
                ...
                onTap: () => _openStaticScreen('Privacy Policy', 'privacy_policy'),
              ),
              _SettingItem(
                ...
                onTap: () => _openStaticScreen(context.l10n.aboutApp, 'about_app'),
              ),
            ],
          )),
