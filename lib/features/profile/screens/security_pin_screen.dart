        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              if (email.isEmpty) {
                _snack('No email address found for your account', isError: true);
                return;
              }
              try {
                ...
                _snack('Failed to send reset link', isError: true);
              }
            },
            style: ElevatedButton.styleFrom(
                backgroundColor: AppColors.primary),
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              Navigator.pop(context);
              // Log the user out — backend will handle deactivation on next login
