...
class _VideosTabState extends State<_VideosTab> {
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      ...
      Expanded(child: _loading
          ? const Center(child: CircularProgressIndicator())
          : _seg == 0
              ? _buildSafeboxPlaceholder()
              : _seg == 2
                  ? _buildFoldersPlaceholder()
                  : _permissionDenied
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            const Icon(Icons.video_library_outlined, size: 56, color: Color(0xFFBDBDBD)),
            const SizedBox(height: 16),
            const Text(
              'Photo library access required',
              style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: Color(0xFF424242)),
              textAlign: TextAlign.center,
            ),
            const SizedBox(height: 8),
            const Text(
              'Allow access in Settings → Privacy → Photos to browse your videos.',
  ...
  Widget _buildSafeboxPlaceholder() => const Center(
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(Icons.lock_outline_rounded, size: 48, color: Color(0xFFBDBDBD)),
          SizedBox(height: 12),
          Text('Safebox coming soon',
              style: TextStyle(color: Color(0xFF757575), fontSize: 14)),
        ],
      ));

  Widget _buildFoldersPlaceholder() => const Center(
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(Icons.folder_outlined, size: 48, color: Color(0xFFBDBDBD)),
          SizedBox(height: 12),
    ...
    if (_videos.isEmpty) {
      return const Center(
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(Icons.videocam_off_outlined, size: 56, color: Color(0xFFBDBDBD)),
            SizedBox(height: 12),
            Text(
              'No videos found',
            ...
            SizedBox(height: 6),
            Text(
              'Videos you record or download will appear here.',
